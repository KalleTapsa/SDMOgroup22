...
1. Edit your details to `config.py`. Use your wanted Github repository in the `REPO_PATH` -variable, and put your name in the `TEAM_MEMBER`-variable. Repo can be given as a url or give the path where your repository lies on your computer.
