...
1. Edit your details to `config.py`. Use your wanted Github repository in the `REPO_PATH` -variable, and put your name in the `TEAM_MEMBER`-variable. Repository can be given as an url or give the path where the repository lies on your computer.
